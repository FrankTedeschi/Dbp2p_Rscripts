...
genedata_chr1fw_Sen1norm[,18][is.na(genedata_chr1fw_Sen1norm[,18])]<-0
genedata_chr2fw_Sen1norm[,18][is.na(genedata_chr2fw_Sen1norm[,18])]<-0
genedata_chr3fw_Sen1norm[,18][is.na(genedata_chr3fw_Sen1norm[,18])]<-0
genedata_chr4fw_Sen1norm[,18][is.na(genedata_chr4fw_Sen1norm[,18])]<-0
genedata_chr5fw_Sen1norm[,18][is.na(genedata_chr5fw_Sen1norm[,18])]<-0
genedata_chr6fw_Sen1norm[,18][is.na(genedata_chr6fw_Sen1norm[,18])]<-0
genedata_chr7fw_Sen1norm[,18][is.na(genedata_chr7fw_Sen1norm[,18])]<-0
genedata_chr8fw_Sen1norm[,18][is.na(genedata_chr8fw_Sen1norm[,18])]<-0
genedata_chr9fw_Sen1norm[,18][is.na(genedata_chr9fw_Sen1norm[,18])]<-0
genedata_chr10fw_Sen1norm[,18][is.na(genedata_chr10fw_Sen1norm[,18])]<-0
genedata_chr11fw_Sen1norm[,18][is.na(genedata_chr11fw_Sen1norm[,18])]<-0
genedata_chr12fw_Sen1norm[,18][is.na(genedata_chr12fw_Sen1norm[,18])]<-0
genedata_chr13fw_Sen1norm[,18][is.na(genedata_chr13fw_Sen1norm[,18])]<-0
genedata_chr14fw_Sen1norm[,18][is.na(genedata_chr14fw_Sen1norm[,18])]<-0
genedata_chr15fw_Sen1norm[,18][is.na(genedata_chr15fw_Sen1norm[,18])]<-0
genedata_chr16fw_Sen1norm[,18][is.na(genedata_chr16fw_Sen1norm[,18])]<-0

genedata_chr1rev_Sen1norm[,18][is.na(genedata_chr1rev_Sen1norm[,18])]<-0
genedata_chr2rev_Sen1norm[,18][is.na(genedata_chr2rev_Sen1norm[,18])]<-0
genedata_chr3rev_Sen1norm[,18][is.na(genedata_chr3rev_Sen1norm[,18])]<-0
genedata_chr4rev_Sen1norm[,18][is.na(genedata_chr4rev_Sen1norm[,18])]<-0
genedata_chr5rev_Sen1norm[,18][is.na(genedata_chr5rev_Sen1norm[,18])]<-0
genedata_chr6rev_Sen1norm[,18][is.na(genedata_chr6rev_Sen1norm[,18])]<-0
genedata_chr7rev_Sen1norm[,18][is.na(genedata_chr7rev_Sen1norm[,18])]<-0
genedata_chr8rev_Sen1norm[,18][is.na(genedata_chr8rev_Sen1norm[,18])]<-0
genedata_chr9rev_Sen1norm[,18][is.na(genedata_chr9rev_Sen1norm[,18])]<-0
genedata_chr10rev_Sen1norm[,18][is.na(genedata_chr10rev_Sen1norm[,18])]<-0
genedata_chr11rev_Sen1norm[,18][is.na(genedata_chr11rev_Sen1norm[,18])]<-0
genedata_chr12rev_Sen1norm[,18][is.na(genedata_chr12rev_Sen1norm[,18])]<-0
genedata_chr13rev_Sen1norm[,18][is.na(genedata_chr13rev_Sen1norm[,18])]<-0
genedata_chr14rev_Sen1norm[,18][is.na(genedata_chr14rev_Sen1norm[,18])]<-0
genedata_chr15rev_Sen1norm[,18][is.na(genedata_chr15rev_Sen1norm[,18])]<-0
genedata_chr16rev_Sen1norm[,18][is.na(genedata_chr16rev_Sen1norm[,18])]<-0

#load in Dbp2 peaks
Dbp2_peaks_crick<-read.delim("Dbp2_snRNA_Peaks_3pOnly_CDbox_Crick.txt",sep="\t",header = F, quote="\"", stringsAsFactors=F)
Dbp2_peaks_watson<-read.delim("Dbp2_snRNA_Peaks_3pOnly_CDbox_Watson.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr1fw_Sen1norm$pos, genedata_chr1fw_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr2fw_Sen1norm$pos, genedata_chr2fw_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr3fw_Sen1norm$pos, genedata_chr3fw_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr4fw_Sen1norm$pos, genedata_chr4fw_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr5fw_Sen1norm$pos, genedata_chr5fw_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr6fw_Sen1norm$pos, genedata_chr6fw_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr7fw_Sen1norm$pos, genedata_chr7fw_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr8fw_Sen1norm$pos, genedata_chr8fw_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr9fw_Sen1norm$pos, genedata_chr9fw_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr10fw_Sen1norm$pos, genedata_chr10fw_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr11fw_Sen1norm$pos, genedata_chr11fw_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr12fw_Sen1norm$pos, genedata_chr12fw_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr13fw_Sen1norm$pos, genedata_chr13fw_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr14fw_Sen1norm$pos, genedata_chr14fw_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr15fw_Sen1norm$pos, genedata_chr15fw_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr16fw_Sen1norm$pos, genedata_chr16fw_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr1rev_Sen1norm$pos, genedata_chr1rev_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr2rev_Sen1norm$pos, genedata_chr2rev_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr3rev_Sen1norm$pos, genedata_chr3rev_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr4rev_Sen1norm$pos, genedata_chr4rev_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr5rev_Sen1norm$pos, genedata_chr5rev_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr6rev_Sen1norm$pos, genedata_chr6rev_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr7rev_Sen1norm$pos, genedata_chr7rev_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr8rev_Sen1norm$pos, genedata_chr8rev_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr9rev_Sen1norm$pos, genedata_chr9rev_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr10rev_Sen1norm$pos, genedata_chr10rev_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr11rev_Sen1norm$pos, genedata_chr11rev_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr12rev_Sen1norm$pos, genedata_chr12rev_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr13rev_Sen1norm$pos, genedata_chr13rev_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr14rev_Sen1norm$pos, genedata_chr14rev_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr15rev_Sen1norm$pos, genedata_chr15rev_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#Ded1 Data vector
S1clip<-NULL
S1clip<-as.data.frame(cbind(genedata_chr16rev_Sen1norm$pos, genedata_chr16rev_Sen1norm$Sen1_clipnorm))
colnames(S1clip)=c("pos","Sen1_clipnorm")
...
#write.table(D2BindingPeaks_Sen1normsurround_all, file = "Sen1_CDboxBinding_D2peaks_forRand.txt", sep = "\t",row.names = F,col.names = T, quote=F)
...
m<-tapply(D2BindingPeaks_Sen1normsurround_all$Sen1_clipnorm,list(D2BindingPeaks_Sen1normsurround_all$Distance), mean,na.rm=T)
View(m)
