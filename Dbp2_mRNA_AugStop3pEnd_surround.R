...
##not gonna use that genedata since it's not the average. Using the AnnotatedNorm_chr_mean_filter D2 average instead
genedata_chr1fw_Sen1norm <- genedata_chr1fw
genedata_chr2fw_Sen1norm <- genedata_chr2fw
genedata_chr3fw_Sen1norm <- genedata_chr3fw
genedata_chr4fw_Sen1norm <- genedata_chr4fw
genedata_chr5fw_Sen1norm <- genedata_chr5fw
genedata_chr6fw_Sen1norm <- genedata_chr6fw
genedata_chr7fw_Sen1norm <- genedata_chr7fw
genedata_chr8fw_Sen1norm <- genedata_chr8fw
genedata_chr9fw_Sen1norm <- genedata_chr9fw
genedata_chr10fw_Sen1norm <- genedata_chr10fw
genedata_chr11fw_Sen1norm <- genedata_chr11fw
genedata_chr12fw_Sen1norm <- genedata_chr12fw
genedata_chr13fw_Sen1norm <- genedata_chr13fw
genedata_chr14fw_Sen1norm <- genedata_chr14fw
genedata_chr15fw_Sen1norm <- genedata_chr15fw
genedata_chr16fw_Sen1norm <- genedata_chr16fw

genedata_chr1rev_Sen1norm <- genedata_chr1rev
genedata_chr2rev_Sen1norm <- genedata_chr2rev
genedata_chr3rev_Sen1norm <- genedata_chr3rev
genedata_chr4rev_Sen1norm <- genedata_chr4rev
genedata_chr5rev_Sen1norm <- genedata_chr5rev
genedata_chr6rev_Sen1norm <- genedata_chr6rev
genedata_chr7rev_Sen1norm <- genedata_chr7rev
genedata_chr8rev_Sen1norm <- genedata_chr8rev
genedata_chr9rev_Sen1norm <- genedata_chr9rev
genedata_chr10rev_Sen1norm <- genedata_chr10rev
genedata_chr11rev_Sen1norm <- genedata_chr11rev
genedata_chr12rev_Sen1norm <- genedata_chr12rev
genedata_chr13rev_Sen1norm <- genedata_chr13rev
genedata_chr14rev_Sen1norm <- genedata_chr14rev
genedata_chr15rev_Sen1norm <- genedata_chr15rev
genedata_chr16rev_Sen1norm <- genedata_chr16rev

#load in Dbp2 peaks
Dbp2_peaks_crick<-read.delim("Dbp2_snRNA_Peaks_3pOnly_Hbox_Crick.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
Dbp2_peaks_watson<-read.delim("Dbp2_snRNA_Peaks_3pOnly_Hbox_Watson.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
