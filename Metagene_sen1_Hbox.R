...
chr1cd<-read.delim("chr1snRNA_H.txt",sep="\t",header = F, quote="\"", stringsAsFactors=F)
chr2cd<-read.delim("chr2snRNA_H.txt",sep="\t",header = F, quote="\"", stringsAsFactors=F)
chr3cd<-read.delim("chr3snRNA_H.txt",sep="\t",header = F, quote="\"", stringsAsFactors=F)
chr4cd<-read.delim("chr4snRNA_H.txt",sep="\t",header = F, quote="\"", stringsAsFactors=F)
chr5cd<-read.delim("chr5snRNA_H.txt",sep="\t",header = F, quote="\"", stringsAsFactors=F)
chr6cd<-read.delim("chr6snRNA_H.txt",sep="\t",header = F, quote="\"", stringsAsFactors=F)
chr7cd<-read.delim("chr7snRNA_H.txt",sep="\t",header = F, quote="\"", stringsAsFactors=F)
chr8cd<-read.delim("chr8snRNA_H.txt",sep="\t",header = F, quote="\"", stringsAsFactors=F)
chr9cd<-read.delim("chr9snRNA_H.txt",sep="\t",header = F, quote="\"", stringsAsFactors=F)
chr10cd<-read.delim("chr10snRNA_H.txt",sep="\t",header = F, quote="\"", stringsAsFactors=F)
chr11cd<-read.delim("chr11snRNA_H.txt",sep="\t",header = F, quote="\"", stringsAsFactors=F)
chr12cd<-read.delim("chr12snRNA_H.txt",sep="\t",header = F, quote="\"", stringsAsFactors=F)
chr13cd<-read.delim("chr13snRNA_H.txt",sep="\t",header = F, quote="\"", stringsAsFactors=F)
chr14cd<-read.delim("chr14snRNA_H.txt",sep="\t",header = F, quote="\"", stringsAsFactors=F)
chr15cd<-read.delim("chr15snRNA_H.txt",sep="\t",header = F, quote="\"", stringsAsFactors=F)
chr16cd<-read.delim("chr16snRNA_H.txt",sep="\t",header = F, quote="\"", stringsAsFactors=F)
...
genedata_chr1fw<-read.delim("genedata_chr1fwS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr2fw<-read.delim("genedata_chr2fwS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr3fw<-read.delim("genedata_chr3fwS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr4fw<-read.delim("genedata_chr4fwS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr5fw<-read.delim("genedata_chr5fwS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr6fw<-read.delim("genedata_chr6fwS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr7fw<-read.delim("genedata_chr7fwS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr8fw<-read.delim("genedata_chr8fwS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr9fw<-read.delim("genedata_chr9fwS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr10fw<-read.delim("genedata_chr10fwS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr11fw<-read.delim("genedata_chr11fwS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr12fw<-read.delim("genedata_chr12fwS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr13fw<-read.delim("genedata_chr13fwS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr14fw<-read.delim("genedata_chr14fwS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr15fw<-read.delim("genedata_chr15fwS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr16fw<-read.delim("genedata_chr16fwS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)

genedata_chr1rev<-read.delim("genedata_chr1revS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr2rev<-read.delim("genedata_chr2revS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr3rev<-read.delim("genedata_chr3revS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr4rev<-read.delim("genedata_chr4revS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr5rev<-read.delim("genedata_chr5revS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr6rev<-read.delim("genedata_chr6revS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr7rev<-read.delim("genedata_chr7revS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr8rev<-read.delim("genedata_chr8revS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr9rev<-read.delim("genedata_chr9revS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr10rev<-read.delim("genedata_chr10revS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr11rev<-read.delim("genedata_chr11revS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr12rev<-read.delim("genedata_chr12revS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr13rev<-read.delim("genedata_chr13revS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr14rev<-read.delim("genedata_chr14revS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr15rev<-read.delim("genedata_chr15revS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
genedata_chr16rev<-read.delim("genedata_chr16revS1_Norm.txt",sep="\t",header = T, quote="\"", stringsAsFactors=F)
...
Saccer3_MetageneNorm[,1][Saccer3_MetageneNorm[,1]==-Inf]<-NA
#---------------------------------------------------------------------------------------------------
write.table(Saccer3_MetageneNorm,file="Saccer3_MetageneNorm_snRNA_H_Sen1.txt",sep="\t",row.names = F,col.names = T, quote=F)
